-- Replace 'lalamove' and 'grab' pickup modes with a single 'courier' value.
-- The UI now shows "Personal pick-up" and "Courier pick-up" only.
-- Existing bookings with lalamove/grab values are left as-is (historical data).
-- New bookings will use 'courier'.

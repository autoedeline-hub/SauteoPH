...
INSERT INTO public.menu_categories (name, slug, sort_order) VALUES
  ('À la carte Dessert',                                            'a-la-carte-dessert',          10),
  ('Set Menu (WITH POTATO FRESH FRIES and DRINKS) (NO DESSERT)',    'set-menu-no-dessert',         20),
  ('À la carte Drinks',                                             'a-la-carte-drinks',           30),
  ('À la carte Burger (NO SIDES)',                                  'a-la-carte-burger-no-sides',  40)
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM public.menu_items WHERE category_id = cat_setmenu) THEN
    INSERT INTO public.menu_items (category_id, name, description, price, image_url, active, sort_order) VALUES
      (cat_setmenu,
        'BASIC SAUTÉO SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
        E'BASIC SAUTÉO HAMBURGER\nSAUTÉO FRESH FRIES WITH DIP\nBEVERAGE OF YOUR CHOICE\n(NO DESSERT)',
        850, NULL, true, 10),
      (cat_setmenu,
        'DOUBLE-CHEESE CHEESEBURGER SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
        E'DOUBLE CHEESE CHEESEBURGER\nSAUTÉO FRESH FRIES WITH DIP\nBEVERAGE OF YOUR CHOICE\n(NO DESSERT)',
        950, NULL, true, 20),
      (cat_setmenu,
        'DELUXE DOUBLE-CHEESE CHEESEBURGER SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
        E'DELUXE DOUBLE CHEESE CHEESEBURGER\nSAUTÉO FRESH FRIES WITH DIP\nBEVERAGE OF YOUR CHOICE\n(NO DESSERT)',
        1000, NULL, true, 30),
      (cat_setmenu,
        'HIROSHIMA HAMBURGER SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
        E'HIROSHIMA HAMBURGER\nSAUTÉO FRESH FRIES WITH DIP\nBEVERAGE OF YOUR CHOICE\n(NO DESSERT)',
        1000, NULL, true, 40),
      (cat_setmenu,
        'OTTO FORMAGGIO FUNGHI CHEESEBURGER SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
        E'OTTO FORMAGGIO FUNGHI CHEESEBURGER\nSAUTÉO FRESH FRIES WITH DIP\nBEVERAGE OF YOUR CHOICE\n(NO DESSERT)',
        1100, NULL, true, 50),
      (cat_setmenu,
        'CHEEZUROSHIMA CHEESEBURGER SET MENU (WITH POTATO FRESH FRIES AND DRINKS) (NO DESSERT)',
  ...
  IF NOT EXISTS (SELECT 1 FROM public.menu_items WHERE category_id = cat_burger) THEN
    INSERT INTO public.menu_items (category_id, name, description, price, image_url, active, sort_order) VALUES
      (cat_burger, 'BASIC SAUTÉO BURGER (NO SIDES)',                NULL, 450, NULL, true, 10),
      (cat_burger, 'DOUBLE-CHEESE CHEESEBURGER (NO SIDES)',         NULL, 550, NULL, true, 20),
      (cat_burger, 'DELUXE DOUBLE-CHEESE CHEESEBURGER (NO SIDES)',  NULL, 600, NULL, true, 30),
      (cat_burger, 'HIROSHIMA BURGER (NO SIDES)',                   NULL, 600, NULL, true, 40),
      (cat_burger, 'OTTO FORMAGGIO FUNGHI CHEESEBURGER (NO SIDES)', NULL, 700, NULL, true, 50),
      (cat_burger, 'CHEEZUROSHIMA CHEESEBURGER (NO SIDES)',         NULL, 700, NULL, true, 60);
  END IF;
END $$;
